	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Thêm mới khách hàng</span></h4>
			</div>
		...
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li><a href="{{route('admin/customers')}}">Khách hàng</a></li>
				...
				<div class="tab-pane fade in active">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title">Điền thông tin khách hàng</h6>
						...
						<div class="panel-body">
							<form method="post" enctype="multipart/form-data">
								...
								<div class="text-right">
									<button type="submit" class="btn btn-primary">Thêm mới khách hàng <i class="icon-arrow-right14 position-right"></i></button>
								</div>
								{!! csrf_field() !!}
