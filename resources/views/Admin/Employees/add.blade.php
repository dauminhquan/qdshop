...
$js = ['assets/js/core/libraries/jasny_bootstrap.min.js','assets/js/plugins/forms/selects/select2.min.js','assets/js/plugins/forms/styling/uniform.min.js','assets/js/plugins/ui/moment/moment.min.js','assets/js/plugins/ui/fullcalendar/fullcalendar.min.js','assets/js/core/app.js','assets/js/pages/user_profile_tabbed.js','assets/js/plugins/forms/styling/switchery.min.js','assets/js/plugins/notifications/pnotify.min.js','assets/js/build/custom.js'];
$html_js = '';
$count = count($js);
for ($i=0; $i < $count ; $i++)  {
	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Thêm mới nhân viên</span></h4>
			</div>
		...
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li><a href="{{route('admin/index')}}">Nhân viên</a></li>
				...
				<div class="tab-pane fade in active">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title">Điền thông tin nhân viên</h6>
						...
						<div class="panel-body">
							<form method="post" enctype="multipart/form-data">
								<div class="form-group">
									<div class="row">
										<div class="col-md-6">
											...
											<input name="first_name" type="text" value="" class="form-control" required="required">
										</div>
										<div class="col-md-6">
											<label>Tên<span style="color: red">*</span></label>
											<input name="last_name" type="text" value="" class="form-control" required="required">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-6">
											...
											<select class="select-search" name="state_province">
										...
										<div class="col-md-6">
											...
											<select class="select-search" name="wards">
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-6">
											...
											<input type="text" value="" name="address" class="form-control" required="required">
										</div>
										<div class="col-md-6">
											<label>Địa chỉ thường trú<span style="color: red">*</span></label>
											<input type="text" value="" name="permanent_address" class="form-control" required="required">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-4">
											...
											<input name="birth_day" type="date" class="form-control" required="required">
										</div>
										<div class="col-md-4">
											<label>Số chứng minh thư<span style="color: red">*</span></label>
											<input type="text" name="CMT" value="" class="form-control" required="required">
										</div>
										<div class="col-md-4">
											<label>Số điện thoại<span style="color: red">*</span></label>
											<input name="business_phone" type="tel"  class="form-control" required="required">
										</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-4">
											...
											<input type="Email" name="email_address" value="" class="form-control" required="required">
										</div>
										<div class="col-md-4">
											<label>Mật khẩu mới<span style="color: red">*</span></label>
											<input type="password" name="password" placeholder="Nhập mới mật khẩu" class="form-control">
										</div>
										<div class="col-md-4">
											<label>Nhập lại mật khẩu<span style="color: red">*</span></label>
											<input type="password" name="passwordrepeat" placeholder="Nhập lại mật khẩu" class="form-control">
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										<div class="col-md-12">
											<label class="display-block">File đính kèm</label>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-12">
											...
											<textarea nam="notes" rows="8" class="form-control"></textarea>
								...
								<div class="text-right">
									<button type="submit" class="btn btn-primary">Thêm mới nhân viên <i class="icon-arrow-right14 position-right"></i></button>
								</div>
								{!! csrf_field() !!}
...
<script>
	jQuery(document).ready(function($) {
        ...
        new PNotify({
            title: 'Thất bại',
            text: 'Có lỗi trong quá trình thêm nhân viên. Vui lòng kiểm tra lại',
            addclass: 'bg-danger'
        })
