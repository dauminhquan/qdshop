...
<?php
	...
	$js = ['assets/js/core/libraries/jasny_bootstrap.min.js','assets/js/plugins/forms/selects/select2.min.js','assets/js/plugins/forms/styling/uniform.min.js','assets/js/plugins/ui/moment/moment.min.js','assets/js/plugins/ui/fullcalendar/fullcalendar.min.js','assets/js/plugins/notifications/pnotify.min.js','assets/js/core/app.js','assets/js/pages/user_profile_tabbed.js','assets/js/plugins/forms/styling/switchery.min.js','assets/js/plugins/forms/styling/switch.min.js','assets/js/build/custom.js'];
	$html_js = '';
	$count = count($js);
	for ($i=0; $i < $count ; $i++)  {
									...
									<div class="panel-body bg-indigo-400 border-radius-top text-center" style="background-image: url(https://scontent.fhan2-2.fna.fbcdn.net/v/t1.0-9/16684163_661413787362875_6727556996977584083_n.jpg?oh=37cdde42dbb049aee71252976f0ff67d&oe=5A62857C); background-size: contain;">
										...
										<ul class="list-inline list-inline-condensed no-margin-bottom">
											<li>
												...
												<div tabindex="500" class="btn btn bg-indigo btn-rounded btn-icon btn-file"><i class="icon-image2"></i><input type="file" class="file-input" data-value="{{$data->id}}" id="avatar" data-show-caption="false" data-show-upload="false"></div>
											</li>
											li>
										</ul>
									</div>
								...
								<div class="tab-pane fade in active" id="profile">
									...
									<div class="panel panel-flat">
										<div class="panel-heading">
											<h6 class="panel-title">Thông tin nhân viên</h6>
											...
											<form enctype="multipart/form-data" method="post">
												<div class="form-group">
													<div class="row">
														<div class="col-md-6">
															<label>Họ</label>
															<input name="first_name" type="text" value="{{$data->first_name}}" class="form-control" required="required">
														</div>
														<div class="col-md-6">
															<label>Tên</label>
															<input name="last_name" type="text" value="{{$data->last_name}}" class="form-control" required="required">
														</div>
													</div>
												</div>
												<div class="form-group">
													<div class="row">
														<div class="col-md-6">
															...
															<input name="birth_day" type="date" value="{{$data->birth_day}}" class="form-control" required="required">
														</div>
														<div class="col-md-6">
															<label>Số chứng minh thư</label>
															<input type="text" name="CMT" value="{{$data->CMT}}" class="form-control" required>
														</div>
												...
												<div class="form-group">
													<div class="row">
														<div class="col-md-6">
															<label>Email</label>
															<input name="email_address" type="email" value="{{$data->email_address}}"  class="form-control" readonly>
														</div>
														<div class="col-md-6">
								                            <label>Số điện thoại</label>
															<input name="business_phone" type="tel" value="{{$data->business_phone}}"  class="form-control" required="required">
														</div>
													</div>
												</div>
						                        ...
						                        <div class="form-group">
						                        	<div class="row">
						                        		<div class="col-md-6">
															...
															<select class="select-search" name="state_province" data-placeholder="Chọn tỉnh thành" required="required">
																<option></option>
														...
														<div class="col-md-6">
															...
															<select class="select-search" name="wards" data-placeholder="Chọn quận huyện" required="required">
																<option></option>
																@foreach($tinhthanh as $key => $item)
												...
												<div class="form-group">
													<div class="row">
														...
														<div class="col-md-6">
															...
															<input type="text" name="permanent_address" value="{{$data->permanent_address}}" class="form-control" required="required">
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="row">
														<div class="col-md-9">
															<label class="display-block">Sửa file đính kèm</label>
															<input type="file" class="file-styled" name="attachments">
															<span class="help-block">Chỉ chấp nhận file gif, png,jpg. Kích cỡ tối đa à 2Mb</span>
														</div>
														<div class="col-md-3">
															<label class="display-block">@if($data->attachments == '')Không có file đính kèm @else Tải xuống file đính kèm @endif</label>
															<a style="width: 100%;" href="@if($data->attachments == '')# @else {{route('admin/employees/profile/download').'?id='.$data->id}} @endif" class="btn bg-teal"><i class=" icon-file-download2"></i></a>
														</div>
													</div>
												</div>
									...
									<div class="panel panel-flat">
										<div class="panel-heading">
											<h6 class="panel-title">Cài đặt tài khoản</h6>
											<div class="heading-elements">
												<ul class="icons-list">
							                		<li><a data-action="collapse"></a></li>
							                		<li><a data-action="reload"></a></li>
										...
										<div class="panel-body">
											<form method="post">
												<div class="form-group">
													<div class="row">
														<div class="col-md-5">
															...
															<input type="email" name="user_name" value="{{$data->email_address}}" readonly="readonly" class="form-control">
														</div>
												...
												<div class="form-group">
													<label class="display-block text-semibold">Chọn quyền cho nhân viên</label>
													@if(isset($allprivilege))
														@foreach($allprivilege as $item)

															<label class="checkbox-inline">
																<input type="checkbox" class="styled" name="privilege[]" value="{{$item->id}}" @foreach($privileges as $value) @if($value->privilege_id == $item->id) checked="checked" @endif @endforeach>
																{{$item->privilege_name}}
															</label>
														@endforeach
													@endif
						                        ...
						                        <div class="text-right">
						                        	<button type="submit" name="id" value="{{$data->id}}" class="btn btn-primary">Lưu <i class="icon-arrow-right14 position-right"></i></button>
						                        </div>
												{{ csrf_field() }}
