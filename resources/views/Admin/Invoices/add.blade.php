<?php
$js = ['assets/js/plugins/forms/selects/select2.min.js','assets/js/plugins/forms/styling/uniform.min.js','assets/js/core/app.js','assets/js/pages/form_layouts.js','assets/js/build/react.min.js','assets/js/plugins/notifications/pnotify.min.js','assets/js/build/custom.js'];
$html_js = '';
$count = count($js);
for ($i=0; $i < $count ; $i++)  {
...
<div class="content-wrapper">
	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Thêm mới đơn hàng</span></h4>
			</div>
		...
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li><a href="form_layout_vertical.html">Đơn hàng</a></li>
	...
	<div class="content">
		...
		<!-- 2 columns form -->
		<form method="post" id="form_add_invoice">
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">Điền thông tin đơn hàng</h5>
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-md-12">
							<fieldset>
								<legend class="text-semibold"><i class="icon-reading position-left"></i> Thông tin nhận hàng</legend>
								<div class="form-group">
									<label>Chọn người dùng</label>
									<select class="select" name="customer_id" data-placeholder="Chọn người dùng" required="required">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label>Nhập tên người nhận hàng:<span style="color:red">*</span></label>
											<input type="text" placeholder="Tên người nhận hàng" class="form-control" name="ship_name" required="required">
										</div>
									</div>
									<div class="col-md-4">
										<label>Tỉnh/Thành phố</label>
										<select class="select-search" name="ship_state_province" data-placeholder="Chọn tỉnh thành">
											<option></option>
									...
									<div class="col-md-4">
										...
										<select class="select-search" name="ship_wards" data-placeholder="Chọn quận huyện">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="email" placeholder="email@gmail.com" name="email_address" class="form-control" required="required">
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="ship_business_phone" placeholder="+99-99-9999-9999" class="form-control" required="required">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<label>Nhập địa chỉ nhận hàng:<span style="color:red">*</span></label>
									<textarea name="ship_address" rows="5" cols="5" class="form-control" placeholder="Địa chỉ nhận hàng" required="required"></textarea>
								</div>
								<div class="row">
									<label class="">Chọn phương thức thanh toán</label>

									<div class="form-group">


										<div class="col-xs-4 icon-visa">
											<label class="radio-inline ">
												<input type="radio" class="styled" name="payment_type" value="visa">
												<img src="{{asset('assets/images/icons/visa.png')}}" alt="">
											</label>
										</div>
										<div class="col-xs-4 icon-visa">
											<label class="radio-inline ">
												<input type="radio" class="styled" name="payment_type" value="mastercar" >
												<img src="{{asset('assets/images/icons/mastercar.png')}}" alt="">
											</label>
										</div>
										<div class="col-xs-4 icon-visa">
											<label class="radio-inline ">
												<input type="radio" class="styled" name="payment_type" value="Trực tiếp"  checked="checked">
												<img src="{{asset('assets/images/icons/truc-tiep.png')}}" alt="">
											</label>
										</div>
						...
						<div class="col-md-12" >
							<fieldset id="all-product">
								<legend class="text-semibold"><i class="icon-cart5 position-left"></i> Thông tin đơn hàng</legend>
							</fieldset>
							<hr>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="text-semibold">Tổng tiền của hóa đơn: <b id="sum-invoice">0</b><sup>đ</sup></label>
										</div>
									</div>
								</div>
							<button type="button" id="add-product" class="btn btn-link"><span class=" icon-cart-add"></span> Thêm sản phẩm</button>
						</div>
					...
					<div class="text-right">
						<button type="submit" class="btn btn-primary">Lưu đơn hàng<i class="icon-arrow-right14 position-right"></i></button>
					</div>
				</div>
			</div>
		</form>
