...
sessionStorage:localStorage).getItem("DataTables_"+a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": chọn để sắp xếp tăng dần",
sSortDescending:": chọn để sắp xếp giảm dần"},oPaginate:{sFirst:"Đầu",sLast:"Cuối",sNext:"Tiếp",sPrevious:"Quay về"},sEmptyTable:"Không có dữ liệu",sInfo:"Hiển thị _START_ đến _END_ của _TOTAL_ danh mục",sInfoEmpty:"Hiển thị 0 đến 0 của 0 danh mục",sInfoFiltered:"(Đã tìm kiếm trong _MAX_ danh mục)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ danh mục",sLoadingRecords:"Đang tìm...",sProcessing:"Đang chạy...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy danh mục nào!"},
