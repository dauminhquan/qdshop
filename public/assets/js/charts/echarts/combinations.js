...
$(function () {
    ...
    require.config({
        baseUrl: window.location.origin+'/assets/js/plugins/visualization',
    ...
    require(
        ...
        function (ec, limitless) {
            ...
            connect_pie_options = {
                ...
                title: {
                    text: 'Nhóm sản phẩm',
                    subtext: 'So sánh các nhóm sản phẩm',
                    x: 'center'
                },
                ...
                legend: {
                    orient: 'vertical',
                    x: 'left',
                    data: [xinchao,'Opera','Safari','Firefox','Chrome']// danh sach nhom san pham
                },
                ...
                series: [{
                    ...
                    center: ['50%', '57.5%'],
                    data: [
                        {value: 335, name: xinchao},
                        {value: 310, name: 'Opera'},
                        {value: 234, name: 'Safari'},
                        {value: 135, name: 'Firefox'},
                        {value: 1548, name: 'Chrome'}
                    ]//chuoi json ve thong ke
                }]
            };
            ...
            connect_column_options = {
                ...
                // Add legend
                legend: {
                    data: [xinchao,'Opera','Safari','Firefox','Chrome']
                },
                ...
                toolbox: {
                    ...
                    feature: {
                        mark: {
                            show: true,
                            title: {
                                mark: 'Vẽ đường biểu đồ',
                                markUndo: 'Hoàn tác',
                                markClear: 'Xóa đường biểu diễn'
                            }
                        },
                        magicType: {
                            show: true,
                            title: {
                                line: 'Chuyển qua dạng đường thẳng',
                                bar: 'Chuyển qua dạng thanh',
                                stack: 'Chuyển sang dạng cây',
                                tiled: 'chuyển qua dạng lát gạ<ch></ch>'
                            },
